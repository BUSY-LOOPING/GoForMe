...
class OrderController {
  ...
  async getAvailableOrders(req, res, next) {
    try {
      ...
      const result = await orderService.getAvailableOrders(runnerId, { page, limit });
  ...
  async updateOrderStatus(req, res, next) {
    try {
      ...
      const order = await orderService.updateOrderStatus(id, runnerId, status, notes);
  ...
  async getAllOrders(req, res, next) {
    try {
      ...
      const result = await orderService.getAllOrders({ status, runner_id, page, limit });
